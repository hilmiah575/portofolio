...
export default function Navigation(){
    return( 
         <div   className="fixed buttom-4 left-0 right-0 text-center z-10 lg:translate-y-[-50%] lg:top-[50%] lg:left-auto lg:right-5 ">
        ...
        <Link
         to="home"
         className="flex w-[50px] h-[50px] juatify-center items-center cursor-pointer" 
         activeClass="active" 
         offset={-100} 
         smooth={true}
         spy={true}
